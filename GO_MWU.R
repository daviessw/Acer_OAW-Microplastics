...
setwd("~/Dropbox/Acer_Microplastics/GO_enrichment") 

# Edit these to match your data file names: 
# source("nrify_GOtable.pl")
input="go_OAW_MP.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
goAnnotations="amil_gene2go.tab" # two-column, tab-delimited, one line per gene, multiple GO terms separated by semicolon. If you have multiple lines per gene, use nrify_GOtable.pl prior to running this script.
...
# Plotting results
quartz()
pdf("OAW_MP_BP.pdf",height=20,width=7.5)
